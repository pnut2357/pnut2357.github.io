...
![api](/assets/images/intro_api/api.png){:height="800px" width="600px"}  
| Fig1. API Overview|
...
![food_del](/assets/images/intro_api/food_del.png){:height="800px" width="600px"}  
...
![api_work](/assets/images/intro_api/api_work.png){:height="800px" width="600px"}  
| Fig1. API analogy|
...
![poketmon](/assets/images/intro_api/poketmon.png){:height="800px" width="400px"}  
| Fig1. client_server Relationship|

## Categories of API
- Web-based System: A web API is an interface to either a web service or a web browser. These APIs work at the server end or the client end. Twitter REST API, Facebook Graph API, and Amazon S3 REST API are web-based API examples.
...
> ![rest](/assets/images/intro_api/rest.png){:height="700px" width="300px"} If you want to understand how it works compared to SOAP, check [here](https://smartbear.com/blog/test-and-monitor/soap-vs-rest-whats-the-difference/).

- Operating System: There are multiple OS based APIs that provide functionality of various OD features. Cocoa, Carbon,  and WinAPI are OS based API examples.

- Database System: These APIs communicate between an application and a database management system, receiving the requested data in a predefined format and provide a structured
...
## ??
Just like a webpage is rendered, APIs can use HTTP requests to get information from a web-application/web-server
