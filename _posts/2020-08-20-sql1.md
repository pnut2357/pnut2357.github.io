...
. This is motivated by [DataCamp's Joining Data in SQL](https://learn.datacamp.com/courses/joining-data-in-postgresql) and [DataCamp's Intermediate SQL](https://learn.datacamp.com/courses/intermediate-sql). The former one is queried via PostgreSQL and the latter one is studied via SQLite3. If you are interested in implementing my code, check [here](https://github.com/pnut2357/DataBase).
