...
Although a recommendation system can use SL or UL, it is neither of them (in my view) because it uses both algorithms as 'tools'. When classifying items into recommended or not, labeling (classification) is needed. When understanding customers' behaviors on an item, it uses UL (content-based, collaborative filtering, or both).

![Recommender](/assets/images/ml_basic1/rco.png){:height="700px" width="400px"}  
| Fig6. Recommender|
...
![CBF vs. CL](/assets/images/ml_basic1/recom.png){:height="700px" width="400px"}  
| Fig7. CBF vs. CF|
